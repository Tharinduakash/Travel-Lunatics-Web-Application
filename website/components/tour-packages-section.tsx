...
const FEATURED = [
  {
    ...
    days: 10,
    nights: 9,
    tagline: '9 Nights · 10 Days Highlights Journey',
    description: `Ancient kingdoms, sacred rock fortresses, wildlife safaris, misty highlands and golden beaches — the complete Sri Lanka experience in one perfectly paced journey.`,
    image: '/webp/sigiriya1.webp',
    price: 'From $480',
    badge: 'Most Popular',
    badgeColor: '#c6a25c',
    highlights: ['Sigiriya Rock Fortress', 'Minneriya Elephant Safari', 'Kandy Temple of Tooth', 'Nuwara Eliya Tea Country', 'Weligama Beach'],
  ...
  },
  {
    ...
    days: 11,
    nights: 10,
    tagline: 'Spiritual Journey & Heritage Tours',
    description: `Experience the soul of Sri Lanka — ancient Buddhist kingdoms, sacred mountains, spiritual temples and breathtaking highland scenery on a deeply meaningful journey.`,
    image: '/webp/Aukana Buddha Statue.webp',
    price: 'From $520',
    badge: 'Fan Favourite',
    badgeColor: '#7c3aed',
    highlights: ['Aukana Buddha Statue', 'Dambulla Cave Temple', 'Temple of Tooth Relic', 'Sigiriya Frescoes', 'Polonnaruwa Ruins'],
    buttonText: 'View Packages',
    href: '/sacred-sri-lanka',
    size: 'medium',
  },
]
...
const HIGHLIGHT_PKGS = [
  {
    ...
    highlights: ['Wilpattu Leopard Safari', 'Minneriya Elephant Herd', 'Udawalawe National Park', 'Mirissa Whale Watching'],
    description: 'Leopards, elephants, blue whales and exotic birds — experience Sri Lanka\'s untamed wildlife with expert guides.',
    href: '/wildlife-tours',
    accent: '#2e7d52',
  },
  {
    ...
    highlights: ['Weligama Beach Leisure', 'Mirissa Whale Watching', 'Galle Fort & Unawatuna', 'Turtle Beach at Rekawa'],
    description: 'Pristine shores, marine adventures and coastal paradise from the south to the north of Sri Lanka.',
    href: '/beach-tours',
    accent: '#0369a1',
  },
  {
    ...
    highlights: ['Village Home Visits', 'Fish Market Experience', 'Bullock Cart & Boat Rides', 'Tea Estate Plantation Life'],
    description: 'Real homes, real food, real traditions — connect with the true heart of Sri Lanka beyond the tourist trail.',
