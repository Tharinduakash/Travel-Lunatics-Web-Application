...
const packages: TourPackage[] = [
  {
    id: 1,
    image: '/webp/860cd182f9a140ec93fd7ddcbdc07baa.webp',
  ...
  },
  {
    ...
    description: `A deep cultural immersion designed for travelers who want to experience Sri Lanka as it truly is lived by locals — not as a tourist show. Real homes, real food, real traditions, and real daily life across villages, towns, and coastal communities, ending with relaxation in Weligama.`,
    days: [
      { day: 'Day 1', title: 'Arrival in Negombo (Coastal Welcome)', desc: 'Warmly welcomed by your chauffeur guide and transferred to Negombo. Evening free to relax by the beach and observe local fishing boats and lagoon life.' },
      { day: 'Day 2', title: 'Fishing Village Life Experience', desc: 'Early morning fish market visit where fishermen bring in their fresh catch. Fishing village visit and lagoon boat ride through mangroves and island communities.' },
      { day: 'Day 3', title: 'Rural Village Experience (Habarana Region)', desc: 'Bullock cart ride through farming paths, catamaran boat ride on a village reservoir, and traditional rice and curry cooking with local families using firewood.' },
      { day: 'Day 4', title: 'Farming & Agricultural Life', desc: 'Observe paddy fields, irrigation systems, and seasonal farming activities. Interact with farmers in rice fields and vegetable plantations.' },
      { day: 'Day 5', title: 'Sigiriya Local Community & Village Culture', desc: 'Visit villages surrounding Sigiriya, interact with local families, and attend a cultural storytelling session.' },
      { day: 'Day 6', title: 'Polonnaruwa Rural Heritage Life', desc: 'Explore the ancient city from a local perspective, seeing how communities live beside ancient monuments.' },
      { day: 'Day 7', title: 'Kandy Local City Life', desc: 'Local markets, craft villages with artisans producing wood carvings and brass items. Evening walk around Kandy Lake.' },
      { day: 'Day 8', title: 'Hill Country Tea Estate Life (Nuwara Eliya)', desc: 'Visit tea plantations, experience plantation worker life, and learn how tea leaves are plucked, processed, and graded.' },
  ...
  },
  {
    ...
    days: [
      ...
      { day: 'Day 5', title: 'Sigiriya Surrounding Communities', desc: 'Explore villages around Sigiriya. Interact with local families, farmers, and artisans in wood carving and weaving home industries.' },
...
export default function LocalExperiences() {
  return (
    <>
      <Navbar />
      <TourPageLayout
        heroImage="/webp/Galle-lighthouse2-scaled-1.webp"
        heroEyebrow="Live Like a Local"
        heroTitle="Local Village Experiences"
        heroSubtitle="Connect with real Sri Lankan communities, traditions and everyday island life beyond the tourist trail."
        heroGradient="linear-gradient(to bottom, rgba(0,0,0,0.40) 0%, rgba(40,22,0,0.85) 100%)"
